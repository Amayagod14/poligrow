CREATE DATABASE  IF NOT EXISTS `poligrow` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `poligrow`;
...
CREATE TABLE `cierres` (
  ...
  `fecha_cierre_sistema` datetime NOT NULL,
  `carga_interfaz` datetime NOT NULL,
  `dias_retraso` int(11) DEFAULT 0,
  `faltantes` text DEFAULT NULL,
...
--
-- Dumping events for database 'poligrow'
--

--
-- Dumping routines for database 'poligrow'
--
...
-- Dump completed on 2024-11-25 10:22:52
